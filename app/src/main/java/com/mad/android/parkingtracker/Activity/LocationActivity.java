...
if(mLastKnownLocation!=null) {
    ...
    mMap.addMarker(new MarkerOptions().position(currentLocation).title("Current Location"));
                            ...
                            LatLng spotA = new LatLng(43.7774392, -79.336438);
                            mMap.addMarker(new MarkerOptions().position(spotA).title("Lot A"));

                            LatLng spotB = new LatLng(43.773523, -79.334563);
                            mMap.addMarker(new MarkerOptions().position(spotB).title("Lot B"));

                            LatLng spotC = new LatLng(43.773223, -79.331834);
                            mMap.addMarker(new MarkerOptions().position(spotC).title("Lot C"));
